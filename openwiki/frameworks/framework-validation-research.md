...
sources:
  - id: openwiki-source-97677bd97d5afd71aedeeb5d
    resource: repo://agent-expertise-framework/01-research-summary.md
...
The research draws on three sibling analysis directories outside this repository (`../../data-lake/amoro-analysis`, `../../data-lake/iceberg-analysis`, `../../data-lake/paimon-analysis`, referenced from [agent-expertise-framework/01-research-summary.md](../../agent-expertise-framework/01-research-summary.md)):
